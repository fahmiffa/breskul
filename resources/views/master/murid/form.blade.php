                ...
                <div class="mb-4">
                    ...
                    <select name="kelas"
                        ...
                        @foreach ($kelas as $row)
                            <option value="{{ $row->id }}" @selected(old('kelas', isset($items) && $items->kelas) == $row->id)>{{ $row->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select name="akademik"
                        ...
                        @foreach ($akademik as $row)
                            <option value="{{ $row->id }}" @selected(old('akademik', isset($items) && $items->akademik) == $row->id)>{{ $row->name }}</option>
                        @endforeach
                    </select>
