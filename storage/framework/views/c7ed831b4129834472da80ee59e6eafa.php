...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6">
        ...
        <form method="POST"
            action="<?php echo e(isset($items) ? route('dashboard.master.app.update', ['app' => $items->id]) : route('dashboard.master.app.store')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="email" name="email" value="<?php echo e(old('email', $items->user->email ?? '')); ?>"
                            class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full  focus:outline-[#177245]">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="text" name="hp" value="<?php echo e(old('hp', $items->user->nomor ?? '')); ?>"
                            class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full  focus:outline-[#177245]">
                    </div>
                    <?php $__errorArgs = ['hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/app/form.blade.php ENDPATH**/ ?>