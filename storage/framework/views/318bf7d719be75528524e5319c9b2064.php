...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6">
    ...
    <form method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-semibold mb-2"><?php echo e(config('app.school_mode') ? 'NIS' : 'NIM'); ?></label>
                <div class="relative">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select name="kelas"
                    ...
                    <option value="<?php echo e($row->id); ?>" <?php if(old('kelas', isset($items) && $items->head->first() ? $items->head->first()->class_id : '') == $row->id): echo 'selected'; endif; ?>><?php echo e($row->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select name="prodi"
                    ...
                    <option value="<?php echo e($row->id); ?>" <?php if(old('prodi', isset($items) && $items->head->first() ? $items->head->first()->prodi_id : '') == $row->id): echo 'selected'; endif; ?>><?php echo e($row->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select name="akademik"
                    ...
                    <option value="<?php echo e($row->id); ?>" <?php if(old('akademik', isset($items) && $items->head->first() ? $items->head->first()->academic_id : '') == $row->id): echo 'selected'; endif; ?>><?php echo e($row->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    <input type="text" name="dad" placeholder="Nama"
                        value="<?php echo e(old('dad', $items->dad ?? '')); ?>"
                        class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full focus:outline-[#177245]">
                    <input type="text" placeholder="Pekerjaan" name="dadJob"
                        value="<?php echo e(old('dadJob', $items->dadJob ?? '')); ?>"
                        class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full focus:outline-[#177245]">
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    <input type="text" name="mom" placeholder="Nama"
                        value="<?php echo e(old('mom', $items->mom ?? '')); ?>"
                        class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full focus:outline-[#177245]">
                    <input type="text" placeholder="Pekerjaan" name="momJob"
                        value="<?php echo e(old('momJob', $items->momJob ?? '')); ?>"
                        class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full focus:outline-[#177245]">
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    <input type="text" name="hp_parent" placeholder="Nomor HP"
                        value="<?php echo e(old('hp_parent', $items->hp_parent ?? '')); ?>"
                        class="border border-gray-300  ring-0 rounded-xl px-3 py-2 w-full focus:outline-[#177245]">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/murid/form.blade.php ENDPATH**/ ?>