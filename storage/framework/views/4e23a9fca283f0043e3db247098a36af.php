...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="accountManagement(<?php echo e(json_encode($items)); ?>, <?php echo json_encode(config('app.school_mode') ? true : false, 15, 512) ?>)">
    ...
    <div class="mb-4 flex flex-wrap justify-between items-center gap-2">
        ...
        <div class="flex gap-2">
            <a :href="'<?php echo e(route('dashboard.master.akun.export')); ?>?kelas=' + filterKelas"
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/franken/breskull/resources/views/master/akun/index.blade.php ENDPATH**/ ?>