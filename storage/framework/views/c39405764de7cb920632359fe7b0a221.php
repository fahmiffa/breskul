...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable(<?php echo e(json_encode($items)); ?>)">
        ...
        <div class="mb-4 flex justify-between items-center gap-2">
            ...
            <a href="<?php echo e(route('dashboard.master.guru.create')); ?>"
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/guru/index.blade.php ENDPATH**/ ?>