...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
        <div class="relative z-10">
            ...
            <div class="text-3xl font-bold mb-4">Rp <?php echo e(number_format($totalPaymentPaid, 0, ',', '.')); ?></div>
    ...
    <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
        <div class="relative z-10">
            ...
            <div class="text-3xl font-bold mb-4">Rp <?php echo e(number_format($totalPaymentUnpaid, 0, ',', '.')); ?></div>
            <div class="flex items-center gap-2 text-sm bg-white/20 w-fit px-3 py-1 rounded-full border border-white/30">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden mb-8">
    <div class="p-6 border-b border-gray-50 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('dashboard.penjadwalan-ujian.index')); ?>" class="text-sm text-green-600 font-semibold hover:text-green-700 flex items-center gap-1 transition-colors">
            Lihat Detail
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-50">
                <?php $__empty_1 = true; $__currentLoopData = $examSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                $total = $row->sudah + $row->belum;
                $percent = $total > 0 ? round(($row->sudah / $total) * 100) : 0;
                ?>
                <tr class="hover:bg-gray-50/80 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap font-semibold text-gray-700"><?php echo e($row->class_name); ?></td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-50 text-orange-700 text-sm font-medium">
                            ...
                            <?php echo e($row->belum); ?> Siswa
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="flex-1 bg-gray-100 rounded-full h-2 overflow-hidden max-w-[120px]">
                                <div class="bg-green-500 h-full rounded-full transition-all duration-500" style="width: <?php echo e($percent); ?>%"></div>
                            </div>
                            <span class="text-sm font-bold text-gray-600 min-w-[40px]"><?php echo e($percent); ?>%</span>
                        </div>
                    </td>
                </tr>
