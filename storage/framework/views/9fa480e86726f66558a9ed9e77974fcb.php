...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable(<?php echo e(json_encode($items)); ?>)">
        ...
        <div class="mb-4 flex justify-between items-center gap-2">
            ...
            <a href="<?php echo e(route('dashboard.master.app.create')); ?>"
            ...
            <table class="min-w-full bg-white border border-gray-200 text-sm">
                <thead>
                    <tr class="bg-green-500 text-left text-white">
                        ...
                        <th @click="sortBy('tahun')" class="cursor-pointer px-4 py-2">Email</th>
                ...
                <tbody>
                    <template x-for="(row, index) in paginatedData()" :key="row.id">
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-2" x-text="row.user.email"></td>
                            <td class="px-4 py-2 flex items-center gap-1">
                                <a :href="'/dashboard/master/app/' + row.id + '/edit'"
                                ...
                                <form :action="'/dashboard/master/app/' + row.id" method="POST"
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/app/index.blade.php ENDPATH**/ ?>