...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable(<?php echo e(json_encode($items)); ?>)">
        ...
        <div class="mb-4 flex justify-between items-center gap-2">
            ...
            <a href="<?php echo e(route('dashboard.master.pembayaran.create')); ?>"
                    ...
                    <template x-for="(row, index) in paginatedData()" :key="row.id">
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-2 flex items-center gap-1">
                                ...
                                <form :action="'/dashboard/master/pembayaran/' + row.id" method="POST"
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/franken/breskull/resources/views/master/payment/index.blade.php ENDPATH**/ ?>