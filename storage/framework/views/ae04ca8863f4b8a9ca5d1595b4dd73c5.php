...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6">
        ...
        <?php if(isset($items)): ?>
            <form method="POST" action="<?php echo e(route('dashboard.master.mapel.update', ['mapel'=>$items->id])); ?>" class="grid grid-cols-1">
                <?php echo method_field('PUT'); ?>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('dashboard.master.mapel.store')); ?>" class="grid grid-cols-1">
                <?php endif; ?>
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/mapel/form.blade.php ENDPATH**/ ?>