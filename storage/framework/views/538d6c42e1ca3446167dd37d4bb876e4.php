...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable(<?php echo e(json_encode($items)); ?>)">
    ...
    <form action="<?php echo e(route('dashboard.absensi')); ?>" method="GET" class="mb-6 flex flex-wrap items-end gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
        <div class="flex flex-col gap-1">
            <label class="text-xs font-bold text-gray-600 uppercase tracking-wider">Tanggal Mulai</label>
            <input type="date" name="start_date" value="<?php echo e($start); ?>"
        ...
        <div class="flex flex-col gap-1">
            ...
            <input type="date" name="end_date" value="<?php echo e($end); ?>"
                class="border border-gray-300 rounded-lg px-3 py-2 focus:outline-green-500 focus:ring-1 focus:ring-green-500 text-sm shadow-sm" />
        </div>
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('dashboard.absensi')); ?>" class="bg-white hover:bg-gray-100 text-gray-700 border border-gray-300 font-bold py-2 px-6 rounded-lg transition duration-200 text-sm flex items-center justify-center shadow-sm">
                Reset
            </a>
        </div>
    </form>
