...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="accountManagement(<?php echo e(json_encode($items)); ?>)">
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/akun/index.blade.php ENDPATH**/ ?>