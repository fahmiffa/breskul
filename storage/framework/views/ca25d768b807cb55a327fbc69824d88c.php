...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6">
    <form method="POST"
        ...
        x-data="{
            ...
            isPaid: <?php echo e(old('is_paid', isset($items) ? ($items->is_paid ? 'true' : 'false') : 'false')); ?>,
            harga: '<?php echo e(old('harga', isset($items) ? ($items->harga ?? 0) : 0)); ?>',
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/franken/breskull/resources/views/master/ujian/form.blade.php ENDPATH**/ ?>