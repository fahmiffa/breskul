...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6">
        ...
        <form method="POST"
            action="<?php echo e(isset($items) ? route('dashboard.master.pembayaran.update', ['pembayaran' => $items->id]) : route('dashboard.master.pembayaran.store')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4" x-data="currencyInput('<?php echo e(old('nominal',isset($items) ? $items->nominal : "")); ?>')">
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\project\breskul\web\resources\views/master/payment/form.blade.php ENDPATH**/ ?>