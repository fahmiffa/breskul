            ...
            <div x-data="generateStudentsImport()">
                <div class="bg-blue-50 rounded-xl p-4 border border-blue-100 flex items-start gap-3 mb-4">
                    ...
                    <div class="text-xs text-blue-700 leading-relaxed">
                        ...
                        <br>
                        <a href="<?php echo e(route('dashboard.master.murid.template')); ?>" class="font-bold underline hover:text-blue-800">Download Template di sini</a>
                    </div>
                </div>
...
<?php echo $__env->make('base.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/franken/breskull/resources/views/master/murid/index.blade.php ENDPATH**/ ?>